...
import com.example.android.SimpleCalc.util.view.BaseActivity;
...
public final class MainActivity extends BaseActivity {
     ...
     */
    private static String getOperandText(final EditText operandEditText) {
    ...
    public void onDiv(View view) {
        try {
            ...
            showToast(R.string.zero_divisor_error_message);
        }
    }
